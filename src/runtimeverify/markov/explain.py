...
class TransitionExplanation(BaseModel):
    ...
    observed_transition_count: int = Field(..., description="Number of times this specific transition was seen during training")
    ...
    expected_transitions: List[Dict[str, Any]] = Field(
        ...
        description="Top expected target states from the source state and their probabilities"
    )
