...
class StateContext(BaseModel):
    ...
    resource_id: Optional[str] = Field(
        None, description="The resource ID involved, e.g. a filename, database table name, or network IP"
    )
    resource_type: Optional[str] = Field(
        None, description="The type classification of the resource (e.g., config, script, sensitive_file)"
    )
    ...
    previous_state_id: Optional[str] = Field(
        None, description="Reference ID to the preceding ExecutionState in the trace"
    )
